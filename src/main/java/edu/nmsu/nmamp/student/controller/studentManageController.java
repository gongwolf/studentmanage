...
public class studentManageController {
	...
	public String searchApplicantByPersonProgram(ModelMap model, @PathVariable("user_id") int user_id,
			Principal principal) {
		...
		//
		// try {
		// model.addAttribute("yearlyBeans",
		// objectMapper.writeValueAsString(yearlybeans));
